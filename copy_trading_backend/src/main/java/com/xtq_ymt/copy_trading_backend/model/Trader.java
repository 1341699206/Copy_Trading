...
public class Trader {
    ...
    @Column(name = "trader_rate", precision = 5, scale = 2) // 指定列名及精度
    ...
    @Column(name = "amount_following", precision = 18, scale = 8)
    ...
    @Column(name = "total_profit_money", precision = 18, scale = 8)
    private Double totalProfitMoney; // 总盈利或亏损金额

    @Column(name = "weeks")
    private Integer weeks; // 活跃周数

    @Column(name = "maximum_drawdown", precision = 18, scale = 8)
    private Double maximumDrawdown; // 最大回撤金额

    @Column(name = "maximum_drawdown_percent", precision = 5, scale = 2)
    ...
    @Column(name = "avg_trade_seconds", precision = 10, scale = 2)
    private Double avgTradeSeconds; // 每笔交易的平均持仓时间（秒）

    @Column(name = "avg_pips_per_trade", precision = 10, scale = 2)
    ...
    @Column(name = "uninterrupted_live_follower_profit", precision = 18, scale = 8)
    private Double uninterruptedLiveFollowerProfit; // 未中断的跟随者利润

    @Column(name = "interrupted_live_follower_profit", precision = 18, scale = 8)
